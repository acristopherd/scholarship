        ...
        <div class="tab-content">
        	...
        	<div class="tab-pane fade" id="account">
	            ...
	            <div class="control-group span9">
                    <div class=">
                    	<div class="h6"><div class="row">Type the words below</div> 
                ...
                <div class="card-comments">
                   	<a class="btn btn-primary" href="#education" data-toggle="tab" aria-expanded="false">Back</a> <?php echo form_submit(array("value"=>"Save","class"=>"btn btn-success")); ?>
                </div>
            	</div>                         
        	</div>
        </div>
