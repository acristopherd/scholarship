...
<div id="page-wrapper">
    ...
    <h1 class="text-center"> Scholars of <?php echo $scholars[0]->college ?></h1>
    ...
    <div class = "row">    	    
    	<table class="margin-auto table table-striped table-hover table-responsive" id ="scholars-table">
    		<thead><tr class="table-header"><th></th><th>Name</th><th>Sex</th><th>Address</th><th>Scholarship</th><th>Course</th><th>Year Level</th></tr></thead>
    		<tbody>
    			<?php
    			$no=1;    			
